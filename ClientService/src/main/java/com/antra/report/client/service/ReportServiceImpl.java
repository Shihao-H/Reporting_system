...
public class ReportServiceImpl implements ReportService {
    ...
    private void sendDirectRequests(ReportRequest request) {
        ...
        try {
            excelResponseFuture = es.submit(()->rs.postForEntity("http://localhost:8888/excel", request, ExcelResponse.class).getBody());
...
//            }
    ...
    @Override
    public String generateReports(ReportRequest request) {
