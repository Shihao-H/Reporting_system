...
//        for(ExcelFile ee: excelService.getExcelList())
//        {
//            System.out.println("signal:  " + ee.getFileId());
//        }
...
//        response.setHeader("Content-Disposition", "attachment; filename=\"name_of_excel_file.xls\""); // TODO: File name cannot be hardcoded here
        ...
        response.setHeader("Content-Disposition", sb.toString()); // TODO: File name cannot be hardcoded here
